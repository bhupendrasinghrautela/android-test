...
/**
 * Created by rohitgarg on 3/17/16.
 */
public class CustomHttpStack implements HttpStack {
    ...
    public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders) throws IOException, AuthFailureError {
        ...
        while (true) {
            ...
            if (responseCode1 == -1) {
            ...
            } else if((responseCode1 == 301 || responseCode1 == 302)
                ...
                while(var12.hasNext()) {
                    ...
                    if(header.getKey() != null) {
                        if("location".equalsIgnoreCase(header.getKey().toString())) {
                            url = (String) ((List) header.getValue()).get(0);
                            changed = true;
                            break;
                        }
                    }
