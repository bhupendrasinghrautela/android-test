...
//                adapter.setSelectedMarkerPosition(0, true);
    ...
    private class ListingAndMarkerAdapter {
        ...
        private void setUpClusterer() {
            ...
            // Position the map.
            mPropertyMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(51.503186, -0.126446), 10));

            // Initialize the manager with the context and the map.
            // (Activity extends context, so we can pass 'this' in the constructor.)
            mClusterManager = new ClusterManager<MyItem>(getActivity(), mPropertyMap);
