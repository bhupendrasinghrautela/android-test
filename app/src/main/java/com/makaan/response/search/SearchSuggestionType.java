...
public enum SearchSuggestionType {
    ...
    PROJECT_OVERVIEW("PROJECT-OVERVIEW"), LOCALITY_OVERVIEW("LOCALITY-OVERVIEW"),
    CITY_OVERVIEW("CITY-OVERVIEW"), NEARBY_PROPERTIES("NEARBY-PROPERTIES"),
    HEADER_TEXT("HEADER-TEXT"), ERROR("ERROR"), SELLER("SELLER");
